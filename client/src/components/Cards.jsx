      ...
      <div className="flex flex-col justify-between gap-3 bg-white rounded-xl drop-shadow-xl h-96 w-64">
          <div className="flex justify-center">
              <img 
                  src={img} 
                  alt={tittle} 
                  className="h-40 w-40 m-6 rounded-xl" 
              />
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
              <Link
                  to={`/producto/${id}`}
                  className="text-xl rounded-2xl w-24 h-11 border-2 flex flex-row justify-center items-center border-black hover:bg-black hover:text-white m-2"
              >
                  Detalles
              </Link>
          </div>
